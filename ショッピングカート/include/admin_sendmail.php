...
$content .= "https://pf01.newheadworks.com/register.php?cid=" . $contactdate . "&id=" . $_REQUEST['id'] . "&customer_no=" . $_REQUEST['customer_no'] . " \r\n";
...
date_default_timezone_set('Japan');
$contactdate=date('YmdHis');
$content .= "https://pf01.newheadworks.com/reset_pass.php?cid=" . $contactdate . "&id=" . $_REQUEST['id'] . "&customer_no=" . $_REQUEST['customer_no'] . " \r\n";
$content .= "※上記URLのページはこのメール送信後1時間でアクセスできなくなります。\r\n";
$content .= "\r\n";
$content .= "----------------------------------------------- \r\n";
break;
